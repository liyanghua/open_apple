...
# sheet-09（21 镜）：「一分钱一分货」品质论证（母婴材质/机床圆角/耐高温 → 健康第一位）。
_NARRATION_SHEET_09 = [
    ...
    ("只让他们看细节。", "只看细节", "reveal"),
    ("用的都是好料。", "用的都是好料", "proof"),
    ("高透的母婴软玻璃。", "高透软玻璃 · 母婴级", "proof"),
    ("不是那种回收塑料。", "不是回收塑料", "proof"),
    ("没有一点刺鼻异味。", "无异味", "proof"),
    ("孩子都能放心用。", "孩子放心用", "proof"),
    ("边缘光滑，圆角不扎手。", "圆角光滑 · 不扎手", "proof"),
    ("圆角光滑，不扎手。", "圆角不扎手", "proof"),
    ("边角毛刺？不存在的。", "边角无毛刺", "proof"),
    ("更关键的是呢。", "更关键的是", "escalation"),
    ("刚出锅的热盘子热菜。", "热菜直接放", "proof"),
    ("直接放上去。", "热盘直接放", "proof"),
    ("不会收缩。", "不收缩", "proof"),
    ("再不用到处找隔热垫。", "不用隔热垫", "payoff"),
    ("从毕业到现在。", "从毕业到现在", "other"),
...
# sheet-14（30 镜）：「20年30年做好一件事」品牌工厂故事（中国制造/免费裁切/SGS/顾客满意）。
_NARRATION_SHEET_14 = [
    ("二十年三十年，做好一件事。", "20年30年 · 一件事", "hook"),
    ("人家卖的比你便宜？", "比你便宜？", "problem"),
    ("百道工序，只为贴合。", "工艺 · 只为贴合", "proof"),
    ("市场上卖桌垫的很多。", "桌垫很多", "problem"),
    ("但我们为中国制造。", "为中国制造", "reveal"),
    ("顾客满意，才是真开心。", "顾客满意真开心", "proof"),
    ("免费裁切磨边。", "免费裁切磨边", "proof"),
    ("我们家的工厂车间。", "自家工厂车间", "proof"),
    ("桌垫收到货，打开第一时间。", "拆箱第一时间", "proof"),
    ("没有一点异味。", "无异味", "proof"),
    ("SGS 认证，放心用。", "SGS 无味认证", "proof"),
    ("我自己也在用这种桌垫。", "自家也在用", "payoff"),
    ("家里有老人小孩的。", "家里老人小孩", "problem"),
    ("桌子又容易脏。", "桌子容易脏", "problem"),
    ("就需要健康材质的。", "健康材质", "reveal"),
    ("好材料，才敢做承诺。", "好材料好承诺", "proof"),
    ("一年四季，耐磨耐用。", "耐磨耐用", "proof"),
    ("防水防油，一抹就净。", "防水防油", "proof"),
    ("高温热菜，直接放。", "耐高温", "proof"),
    ("不易变形，稳定耐用。", "不易变形", "proof"),
    ("顾客满意，才是真开心。", "顾客满意", "proof"),
    ("用过的人都说好。", "都说好", "proof"),
    ("回购的不在少数。", "回购率高", "proof"),
    ("朋友推荐来的也多。", "朋友推荐", "proof"),
    ("用了半年，依旧如新。", "半年级如新", "proof"),
    ("脏了一擦就干净。", "一擦就净", "proof"),
    ("这是给家人的安心。", "给家人的安心", "payoff"),
    ("也是给生活的体面。", "生活的体面", "payoff"),
    ("20 年品牌，值得托付。", "20年品牌", "payoff"),
    ("", "直播间见", "cta"),
]

# sheet-19（22 镜）：「选桌垫别只图便宜」反偷工减料故事（母婴级/抗造/边角圆滑/免费定制/口碑）。
_NARRATION_SHEET_19 = [
    ("选桌垫，别只图便宜。", "别只图便宜", "hook"),
    ("天天跟食物孩子打交道。", "跟食物孩子打交道", "problem"),
    ("材质差了，是真不行。", "材质差不行", "escalation"),
    ("我们家这款 PVC 软玻璃。", "PVC软玻璃", "reveal"),
    ("用的是母婴级材质。", "母婴级材质", "proof"),
    ("老人小孩天天用。", "老人小孩放心用", "proof"),
    ("而且它真的抗造。", "真的抗造", "proof"),
    ("饮料酒水撒在桌面。", "饮料撒桌面", "proof"),
    ("一擦，一点也不费事。", "一擦不费事", "proof"),
    ("边角处理得圆滑。", "边角圆滑", "proof"),
    ("小孩子的手，随便摸。", "小孩手随便摸", "proof"),
    ("怎么扒拉怎么划都不怕。", "怎么划都不怕", "proof"),
    ("做桌垫这行这么多年。", "做桌垫多年", "other"),
    ("见过太多偷工减料。", "偷工减料见过", "problem"),
    ("但老弟始终觉得。", "老弟觉得", "other"),
    ("口碑比啥都重要。", "口碑最重要", "payoff"),
    ("所以每一块都做扎实。", "每块都扎实", "proof"),
    ("尺寸报给我们。", "尺寸报给我们", "proof"),
    ("都能免费定制。", "免费定制", "proof"),
    ("保证合您心意。", "合您心意", "proof"),
    ("老客户都知道。", "老客户都懂", "payoff"),
