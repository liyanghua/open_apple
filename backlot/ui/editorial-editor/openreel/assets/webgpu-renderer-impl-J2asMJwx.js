...
`;function R(u){const e=new Float32Array(8);return e[0]=u,e}function w(u,e,t,r){const i=new Float32Array(24);return i.set(u,0),i[16]=e,i[17]=t,i[18]=r?.x??0,i[19]=r?.y??0,i[20]=r?.width??1,i[21]=r?.height??1,i}function x(u,e,t,r,i,a){const s=new Float32Array(16),f=u.x/i*2,o=u.y/a*2,n=Math.cos(t),c=Math.sin(t),h=(r.x-.5)*2,l=(r.y-.5)*2;s[0]=e.x*n,s[1]=e.x*c,s[2]=0,s[3]=0,s[4]=-e.y*c,s[5]=e.y*n,s[6]=0,s[7]=0,s[8]=0,s[9]=0,s[10]=1,s[11]=0;const d=f+h*(1-e.x*n)+l*e.y*c,p=o+l*(1-e.y*n)-h*e.x*c;return s[12]=d,s[13]=p,s[14]=0,s[15]=1,s}const S=`
